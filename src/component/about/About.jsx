    ...
    <>
      <div className='flex items-center justify-center h-full w-full overflow-hidden'>
        <div className='flex items-center flex-col w-4xl'>
          ...
          {!currentUser && <Link className='mt-4 font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 bg-blue-900/80 text-white hover:bg-blue-950 focus:ring-primary-300 text-base px-5 py-2.5 gap-2.5 flex-1' to='/sign-up'>Sign up</Link>}
