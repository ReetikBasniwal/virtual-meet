  ...
  return (
    <div className='flex mx-10 items-center justify-center h-full w-full overflow-hidden'>
      <div className='flex items-center flex-col'>
        <span className='text-blue-400 italic text-4xl'>Hi {currentUser.firstName} !</span>
        ...
        {currentUser && <button className='rounded pt-1 pb-1 pr-2 pl-2 mt-6 text-2xl font-medium bg-blue-300 w-fit text-slate-600'>Start a meet</button>}
      </div>
    </div>
  )
}
